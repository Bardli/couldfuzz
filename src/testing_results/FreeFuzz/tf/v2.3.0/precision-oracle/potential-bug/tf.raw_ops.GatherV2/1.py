...
try:
  try:
    params_tensor = tf.random.uniform([1, 32000], dtype=tf.float16)
    params = tf.identity(params_tensor)
    indices_tensor = tf.saturate_cast(tf.random.uniform([1, 32000], minval=-256, maxval=257, dtype=tf.int64), dtype=tf.int8)
